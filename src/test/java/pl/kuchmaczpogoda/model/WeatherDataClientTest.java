...
public class WeatherDataClientTest {
    ...
    private static JSONArray EXAMPLE_JSON_ARRAY= JSONConverter.convertStringObjectToJSONArrayWithWeatherData(EXAMPLE_WEATHER_DATA);
    ...
    void shouldReturnCorrectDate(){
        ...
        WeatherDataClient weatherDataClientSpy = spy(WeatherDataClient.class);
        given(weatherDataClientSpy.getDataJsonArray()).willReturn(EXAMPLE_JSON_ARRAY);
        Date exampleDate = new GregorianCalendar(2021, Calendar.SEPTEMBER, 30, 15, 0, 0).getTime();
        //when
